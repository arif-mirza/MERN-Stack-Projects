        ...
        <div className="container py-5">
          <div className="row text-center">
            <div className="col-12">
              <h1 id="section-title-01" data-aos="fade-right">About Me</h1>
              <h1 id="section-title-02" data-aos="fade-left">About Me</h1>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            ...
            <div className="col-12 col-md-8 d-flex justify-content-start align-items-center flex-column">
              <div className="info" style={{ color: "#9fa2ab" }}>
                <h2 className="mb-4 fw-bold about-name text-white"  data-aos="fade-left">
                ...
                <div className="list-sec"  data-aos="zoom-out">
                  <ul class="professional-list">
                    <li class="list-item">
                      <h3 class="counterr" data-target="5+">
                        1+
                      </h3>
                      <span>
                        Years of
                ...
                <div className="container">
                  <div className="row tech-main-sec">
                    <div className=" col"  data-aos="zoom-in" data-aos-duration="1500">
                      <ul className="tect-list d-flex flex-wrap">
                        <li className="list-1">
                          <div className="img ">
